...
st.title("🤖 Offline Ollama Agentic AI Chat: Trip Monitoring Assistant")
st.write("Upload trip data and ask questions. Ollama local model + LangChain agent will select the correct tool and analyze the data.")
...
st.sidebar.header("Offline Ollama Setup")
st.sidebar.write("No API key required.")
...
if uploaded_file is not None:
    ...
    if user_question:
        ...
        with st.chat_message("assistant"):
            with st.spinner("Offline Ollama Agent is thinking and selecting the correct tool..."):
...
st.markdown("---")
st.caption("Offline Ollama Agentic AI Project | Ollama + LangChain + Streamlit + Pandas")
